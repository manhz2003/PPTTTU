...
public class TH2 {
    public void j1_15 (){
        ...
        System.out.println("\nLẬP BẢNG ĐƠN HÌNH");
        System.out.println("+-------------------------------------------------+");
        System.out.println("| Cj | Cơ sở | Phương án | X1 | X2 | X3 | X4 | X5 |");
        System.out.println("+-------------------------------------------------+");
        System.out.printf("%s%25s%1s%3s%2s%3s%2s%3s%2s%3s%2s%3s","| ", "| ", Fx[0], "|", Fx[1], "|", Fx[2], "|", Fx[3],"|", Fx[4],"|");
        System.out.print("\n|-------------------------------------------------|");
        System.out.printf("%s%2s%3s%2s%4s%2s%10s%2s%3s%2s%3s%2s%3s%2s%3s%2s%3s", "\n|", Cj1, "|", " CS1","|", phuongAn1, "|", Ax[0], "|", Ax[1], "|", Ax[2], "|", Ax[3], "|", Ax[4], "|");
        System.out.print("\n|-------------------------------------------------|");
        System.out.printf("%s%2s%3s%2s%4s%2s%10s%2s%3s%2s%3s%2s%3s%2s%3s%2s%3s", "\n|", Cj2, "|", " CS2","|", phuongAn2, "|", Bx[0], "|", Bx[1], "|", Bx[2], "|", Bx[3], "|", Bx[4], "|");
        System.out.print("\n|-------------------------------------------------|");
        System.out.printf("%s%2s%3s%2s%4s%2s%10s%2s%3s%2s%3s%2s%3s%2s%3s%2s%3s", "\n|", Cj3, "|", " CS3","|", phuongAn3, "|", Cx[0], "|", Cx[1], "|", Cx[2], "|", Cx[3], "|", Cx[4], "|");
        System.out.print("\n|-------------------------------------------------|");
        System.out.printf("%s%2s%3s%2s%6s%2s%10s%2s%3s%2s%3s%2s%3s%2s%3s%2s%3s", "\n|", "", "|", "","|", F0, "|", denta1, "|", denta2, "|", denta3, "|", denta4, "|", denta5, "|");
        System.out.print("\n+-------------------------------------------------+");
        System.out.println("\nKẾT LUẬN: VỚI MỌI J = 1...5 --> TA CÓ PHƯƠNG ÁN TỐI ƯU LÀ: ");
        System.out.println("X1 = "+denta1+","+" X2 = "+denta2+","+" X3 = "+denta3+","+" X4 = "+denta4+","+" X5 = "+denta5+","+" và F0 = "+F0);
    }
}
